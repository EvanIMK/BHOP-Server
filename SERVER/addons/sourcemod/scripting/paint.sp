...
#define DEFAULT_FLAG		ADMFLAG_CUSTOM1
...
public void OnPluginStart()
{
	...
	RegAdminCmd( "-paint", cmd_DisablePaint, DEFAULT_FLAG );
	RegAdminCmd( "sm_paintcolour", cmd_PaintColour, DEFAULT_FLAG );
	RegAdminCmd( "sm_paintcolor", cmd_PaintColour, DEFAULT_FLAG );
	RegAdminCmd( "sm_paintsize", cmd_PaintSize, DEFAULT_FLAG );
